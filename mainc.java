...
when one class contain the object of another class this is called containership.

2. In the above situation we have to perform all the operation with the help of multiple objects. 

it creates complexity, generally we preffer, to perform all the opreation with the help of single objects 
not by the diff diff objects, this can be done by INHERITANCE
